...
if( ! function_exists('nbpm_check_license')) {
	function nbpm_check_license() {
		$wppm_license = get_option('wppm_license');
		var_dump($wppm_license);
...
if( ! function_exists('nbpm_get_enable_product')) {
	function nbpm_get_enable_product() {
		global $wpdb;
