...
class WooPanel_Session {
	...
	public function __construct() {
		...
		if( $this->use_php_sessions ) {
			...
			if ( ! class_exists( 'Recursive_ArrayAccess' ) ) {
				require_once WOOPANEL_INC_DIR . 'classes/class-recursive-arrayaccess.php';
			}

	 		if ( ! class_exists( 'WP_Session' ) ) {
				require_once WOOPANEL_INC_DIR . 'classes/class-wp-session.php';
				require_once WOOPANEL_INC_DIR . 'helper/woopanel-session.php';
	 		}
	...
	public function init() {
		...
		if( $this->use_php_sessions ) {
			$this->session = isset( $_SESSION['woopanel' . $this->prefix ] ) && is_array( $_SESSION['woopanel' . $this->prefix ] ) ? $_SESSION['woopanel' . $this->prefix ] : array();
		} else {
	...
	public function set( $key, $value ) {
		...
		if( $this->use_php_sessions ) {
			...
			$_SESSION['woopanel' . $this->prefix ] = $this->session;
		}
