<!--begin::Portlet-->
<div id="chart-amount-wrapper" class="m-portlet m-portlet--tab">
							...
							<div class="m-dropdown__body">
								<div class="m-dropdown__content">
									<ul class="m-nav">
										...
										<li class="m-nav__item" data-value="<?php echo $order_status_key;?>">
											<a href="" class="m-nav__link">
							...
							<div class="m-dropdown__body">
								<div class="m-dropdown__content">
									<ul class="m-nav">
										...
										<li class="m-nav__item<?php echo ($filter_key == $this->chart_default) ? ' active' : false;?>" data-value="<?php echo $filter_key;?>">
											<a href="" class="m-nav__link">
												<span class="m-nav__link-text"><?php echo $filter_value;?></span>
											</a>
										</li>
										<?php }?>
									</ul>
	...
	<?php
		$data_horizontal_json = wp_json_encode($chart_amount['horizontal']);
		...
		$data_vertical_json = wp_json_encode($chart_amount['vertical']);
	...
	?>
	<div class="m-portlet__body chartamount_body" data-horizontal="<?php echo $data_horizontal; ?>" data-vertical="<?php echo $data_vertical; ?>">
		<canvas id="chartamount-<?php echo $tab_default;?>" height="360" style="width: 100%; height: 360px;"></canvas>
	</div>
</div>
<!--end::Portlet-->